#!/usr/bin/env bash
#
# Deterministic release packager for universal-site-announcements.
#
# Usage:
...
#   universal-site-announcements-<version>.zip
#   universal-site-announcements-<version>.zip.sha256
#
...
SLUG="universal-site-announcements"
MAIN_FILE="universal-site-announcements.php"
VERSION_CONST="USA_VERSION"
